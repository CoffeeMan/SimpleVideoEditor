...
public class VideoSliceSeekBar extends ImageView {
    ...
    private int progressMinDiff = 15; //проценты
    private int progressMaxDiff = 100; //проценты
        ...
        if (!blocked) {
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    } else if (mx >= thumbSliceRightX - thumbSliceHalfWidth || mx > thumbSliceRightX + thumbSliceHalfWidth) {
